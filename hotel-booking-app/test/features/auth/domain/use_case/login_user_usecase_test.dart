...
void main() {
  ...
  setUp(() {
    ...
    registerFallbackValue(
        LoginUserParams(email: 'Rangeen70@gmail.com', password: 'admin123'));
  });

  test(
      'should call the [AuthRepo.login] with correct email and password (Rangeen70@gmail.com, admin123)',
      () async {
    when(() => repository.login(any(), any())).thenAnswer(
      (invocation) async {
        final email = invocation.positionalArguments[0] as String;
        final password = invocation.positionalArguments[1] as String;
        if (email == 'Rangeen70@gmail.com' && password == 'admin123') {
  ...
  test('should return a token when login is successful', () async {
    const email = 'Rangeen70@gmail.com';
  ...
  // Test 1: Should return error when login fails due to invalid credentials

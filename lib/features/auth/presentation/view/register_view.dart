...
class _RegisterViewState extends State<RegisterView> {
  ...
  final _nameController = TextEditingController(text: 'Rangeen Twitwi');
  final _usernameController = TextEditingController(text: 'Rangeentwitwi');
  final _emailController = TextEditingController(text: 'Rangeen70@gmail.com');
